...
$val->students_created = date("Y-m-d H:i:s"); //set the students_created to the current date and time
$val->students_updated = date("Y-m-d H:i:s"); //set the students_updated to the current date and time

$query = checkCreate($val); //call the checkCreate function to create a new student and store the result in the variable $query
